...
struct StoryBrain {
    ...
    func getTitle() -> String {
        return storyLine[storyNumber].title
    }
    
    func getChoice1() -> String {
        return storyLine[storyNumber].choice1
    }
    
    func getChoice2() -> String {
        return storyLine[storyNumber].choice2
    }
    
    mutating func getNextStory(title:String) {
        if title == "Choice 1" {
            storyNumber = storyLine[storyNumber].choice1Destination
        }else{
            storyNumber = storyLine[storyNumber].choice2Destination
        }
